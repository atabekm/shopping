...
class ProductRepositoryImpl : ProductRepository {
    ...
    private val products = listOf(
        Product(1, "Nintendo Switch", "Play your favourite games anytime, anywhere, with anyone, with Nintendo Switch", 400f, 360f),
        Product(2, "iPhone Xs Max", "iPhone XS is everything you love about iPhone. Taken to the extreme.", 2000f),
        Product(3, "Pixel 3 XL", "Pixel 3 and Pixel 3 XL are everything you wish your phone could do. Brilliant camera, all day battery, and Google Assistant with a squeeze", 1500f, 1400f),
        ...
        Product(6, "Apple AirPods", "With 24-hour battery life and groundbreaking ease of use and intelligence, AirPods are wireless headphones unlike any other.", 200f, 120f),
        ...
        Product(9, "AudioQuest Nighthawk", "Sophisticated bio-friendly Headphone with style, luxurious comfort and high quality sound.", 1000f, 850f),
